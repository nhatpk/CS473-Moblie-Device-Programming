...
import com.example.navigationdrawerdemo.ui.gallery.GalleryFragment
import com.example.navigationdrawerdemo.ui.home.HomeFragment
import com.example.navigationdrawerdemo.ui.send.SendFragment
import com.example.navigationdrawerdemo.ui.share.ShareFragment
import com.example.navigationdrawerdemo.ui.slideshow.SlideshowFragment
import com.example.navigationdrawerdemo.ui.tools.ToolsFragment
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.nav_slideshow -> {
                ...
                Toast.makeText(applicationContext, "Slide Show Selected", Toast.LENGTH_LONG).show()
                true
            }
            R.id.nav_tools -> {

                Toast.makeText(applicationContext, "Tools Selected", Toast.LENGTH_LONG).show()
                true
            }
            R.id.nav_share -> {
